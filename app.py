...
with ui.sidebar(open="desktop"):
    ui.input_text("textAdditional", "Search for a topic", user_query, placeholder=None, autocomplete='off', spellcheck=None), 
    ui.input_task_button("btn", "search"),
...
@render.text
def btn_click():
    return getReports(str(input.textAdditional)) 
# def _():
#     ui.update_text("textAdditional", str(input.textAdditional))
